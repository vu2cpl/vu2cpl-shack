...
| 16 | ~~Clear LP-700-HID ws tab Description field~~ | **Won't-do 2026-05-11** — cosmetic only. The tab's sidebar Description (legacy `npm install robertsLando/node-red-contrib-usbhid` + telepost udev notes) is editor-only and never user-visible at runtime. No USB-HID code, deps, or runtime references remain anywhere a user could follow them from. Deprioritized |
