...
| 13 | Delete orphan `GPS NTP` flow tab (`4cac0c07e2686c33`) | The 7-widget transitional version's flow tab still exists in `flows.json` with 0 nodes. Right-click tab → Delete. Single-node cleanup, will land in next `nrsave` |
