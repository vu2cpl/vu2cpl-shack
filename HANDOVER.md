...
| Disconnect logic | ✅ **Distance-graded as of 2026-05-12.** 3×3 matrix (AS3935 close/medium/far × OM cold/lit/severe). OM no longer fires DC directly — only corroborates AS3935 hits in medium / far zones. Close zone (<10 km) still single-hit-fires. 7 cfg keys in Init Defaults. Full matrix table in CLAUDE.md "Lightning Antenna Protector" section |
