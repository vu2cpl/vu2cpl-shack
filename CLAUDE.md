...
| # | Item | Status |
|---|------|--------|
| 41 | **HA Radio dashboard phase 2** — lightning ANT/BYPASS buttons need `rest_command` YAML (operator must mount HassPi's Samba `config` share first; SSH closed), and the Flex/SPE/LP-700/Rotator/DXCC/RBN cards need a Node-RED→MQTT state bridge (flow change ⇒ rule #1 approval). Phase 1 (7 data-ready cards, 8 sections, 108 entities) live at `/193-radio` since 2026-08-25. See HANDOVER #41 | Pending |
